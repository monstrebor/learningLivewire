<div>
    ...
    <form wire:submit='registerUser'>
        ...
        <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
            ...
            <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                wire:model='form.name' type="text">
        </div>
        @error('form.name')
            <span class="text-lg bg-white p-1 text-danger">
                {{ $message }}
            </span>
        @enderror
        <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
            ...
            <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                wire:model='form.email' type="email" placeholder="example@email.com">
        </div>
        @error('form.email')
            <span class="text-lg bg-white p-1 text-danger">
                {{ $message }}
        ...
        <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
            ...
            <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
            wire:model.live.debounce.50ms='form.password' type="password" placeholder="Password">
        </div>
        @error('form.password')
            <span class="text-lg bg-white p-1 text-danger">
                {{ $message }}
        ...
        <div class="flex items-center pl-6 mb-6 bg-white rounded-full">
            ...
            <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                wire:model.live.debounce.50ms='form.password_confirmation' type="password"
        ...
        <button
            class="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Get
            started</button>
    </form>
</div>
